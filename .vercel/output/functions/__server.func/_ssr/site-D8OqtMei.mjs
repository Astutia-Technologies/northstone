//#region node_modules/.nitro/vite/services/ssr/assets/site-D8OqtMei.js
var site = {
	name: "Northstone",
...
var services = [
	{
		...
		description: "From tenant sourcing and referencing to renewals and rent collection — a calm, accountable letting service built around long tenancies and well-kept homes.",
		bullets: [
	...
	},
	{
		...
		description: "Transparent service charge budgeting, planned maintenance and clear leaseholder communication — managed with the rigour the role deserves.",
		bullets: [
	...
	},
	{
		...
		description: "Lease management, occupier liaison and asset reporting — tuned to the operational realities of commercial portfolios.",
		bullets: [
	...
	},
	{
		...
		description: "Whether selling tenanted or with vacant possession, we time the market, prepare the asset and coordinate the transaction end-to-end.",
		bullets: [
			"Tenanted & vacant sales",
			"Asset preparation",
	...
	},
	{
		...
		description: "A guaranteed monthly rent, no voids, and a property returned in the condition it was given — suited to landlords who want hands-off certainty.",
		bullets: [
			"Guaranteed monthly rent",
			"Zero voids & no fees",
			"Property returned cared-for"
		],
...
var stats = [
	...
	{
		value: "UK",
		label: "Scotland-focused coverage"
	},
	{
		value: "1:1",
...
var gdprConsent = "I consent to Northstone Property Management contacting me about my enquiry. I have read and agree to the Privacy Policy.";
//#endregion
export { services as a, steps as c, nav as i, faqs as n, site as o, gdprConsent as r, stats as s, enquiryTypes as t };
